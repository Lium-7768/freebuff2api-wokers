...
import { handleCaiChat } from "./cai.js";
...
const MODELS = providers.freebuff.models;
const PREMIUM_QUOTA_MODELS = providers.freebuff.premiumModels;
const STANDARD_MODELS = providers.freebuff.standardModels;
...
async function handleChat(request, env) {
  ...
  const route = resolveProviderModel(requestedModel);
